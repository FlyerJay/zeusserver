  ...
  return app.model.define('Invoice', {
    ...
    classMethods: {
      ...
      * invoiceInfo (options) {
        ...
        SELECT i.*, e.address, e.bankName, e.bankcardNo, e.businessLicense, e.contract, e.enterpriseName, e.invoiceInfo, e.taxNumber, e.telephone, e.auditStatus, e.comId, c.comName, c.enternalName
          FROM invoice i
          INNER JOIN enterprise e
            ON e.enterpriseId = i.enterpriseId
          INNER JOIN company c
