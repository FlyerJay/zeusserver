        ...
        classMethods:{
            ...
            * queryProduct(options){
                ...
                const [$1,$2] = yield [app.model.query(`SELECT si.supplierInventoryId,si.spec,
                    ...
                    si.lastUpdateTime as inventoryTime, sv.lastUpdateTime as valueTime,sv.adjustValue,(s.benifitAdjust + sv.adjustValue) as benifitAdjust,(sv.value - s.benifit) as purePrice,
