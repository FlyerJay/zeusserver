<template lang="html">
  <div>
    <el-card class="box-card">
      ...
      <el-row type="flex" align="middle" style="padding:20px 0;">
        <el-col :span="10">
          <el-button type="primary" @click="dlgSupVisible = true">供应商信息录入</el-button>
          <el-button type="primary" @click="dlgFreightVisible = true">每日运费录入</el-button>
        </el-col>
      </el-row>
    ...
    <el-dialog title="" v-model="dlgSupVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addSup">确 定</el-button>
      </div>
    </el-dialog>
